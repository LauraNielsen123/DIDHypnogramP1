...
function preload() {
  // Load the CSV file
  table = loadTable('cleaned_sleep_Jan.csv', 'csv', 'header');
}
...
function setup() {
  ...
  days = [
    { start: new Date('2024-10-30T20:00:00'), end: new Date('2024-10-31T11:00:00'), day: 1 },
    { start: new Date('2024-10-31T20:00:00'), end: new Date('2024-11-01T11:00:00'), day: 2 },
    { start: new Date('2024-11-01T20:00:00'), end: new Date('2024-11-02T11:00:00'), day: 3 },
    { start: new Date('2024-11-02T20:00:00'), end: new Date('2024-11-03T11:00:00'), day: 4 },
    { start: new Date('2024-11-03T20:00:00'), end: new Date('2024-11-04T11:00:00'), day: 5 },
    { start: new Date('2024-11-04T20:00:00'), end: new Date('2024-11-05T11:00:00'), day: 6 },
...
*/
 ...
 // let optimalSleepMinutes = 8 * 60; 
 // let optimalSleepBarWidth = (optimalSleepMinutes / maxSleepMinutes) * 250; // Skaleret bredde for optimal søvn
 //let sevenHourMinutes = 7 * 60; 
//let sevenHourBarWidth = (sevenHourMinutes / maxSleepMinutes) * 250;

// let sevenHourPosition = (sevenHourMinutes / maxSleepMinutes) * optimalSleepBarWidth;
